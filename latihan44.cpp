...
struct pinjam {
    int kodepinjam, kB, tglpin, tglbalik, dipinjem;
    char namap[40];
    char alamat[40];
    char status;
} pinjembuku[100];
...
login:
    ...
    inbuk:
        ...
        cout << " Judul Buku\t\t:"; cin.ignore(); cin.getline(buku[b].judul, 20);
    ...
    transaksipinjem:
        ...
        cout << " Nama Peminjam Buku \t\t:"; cin.ignore(); cin.getline(pinjembuku[d].namap, 40);
        cout << " Alamat Peminjam \t\t:"; cin.getline(pinjembuku[d].alamat, 40);
